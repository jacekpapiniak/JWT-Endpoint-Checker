...
from helpers.string_helper import is_url
from validators.parser_validator import get_token_type # Import the function to determine the token type

def load_token(token_value: str, email: str, password: str) -> str:
...
def load_token_from_url(url: str, email: str, password: str) ->  str:
    ...
    try:
        ...
        return response.text.strip()  #strip() to remove any leading/trailing whitespace characters that might interfere with our URL check
